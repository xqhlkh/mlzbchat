  ...
  return (
    <div className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
      <div className="sidebar-header">
        <h2>对话历史</h2>
        <button className="btn-icon" onClick={onNew} title="新建对话"><Plus size={18} /></button>
      </div>
      <div className="sidebar-conversations">
        {conversations.length === 0 && (
          <div style={{ padding: '20px 12px', color: 'var(--text-muted)', fontSize: '13px', textAlign: 'center' }}>点击 + 开始新对话</div>
        )}
